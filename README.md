...
Dashboard para controle de validade de itens da geladeira/despensa, com cadastro, edição, exclusão, busca e filtro por categoria. Ajuda a organizar os produtos em casa e evitar desperdício de alimentos vencidos.

> Projeto desenvolvido como forma de aprender e praticar HTML, CSS e JavaScript puro, sem frameworks ou bibliotecas.

## 📸 Screenshot

<!-- Adicione aqui uma imagem do projeto rodando. Exemplo: -->
<!-- ![Tela principal do Minha Despensa](./screenshot.png) -->
...
- [ ] Persistência de dados com `localStorage`, para os produtos não sumirem ao recarregar a página
